...
e|conceptDescription/id e|IRDI (or IRI footnote:prefix[see Table <<Prefixes>>]) e|Code |_prefix_ footnote:prefix[see Table <<Prefixes>>] + _Common Code_  |_prefix_ footnote:prefix[] + _unitId_ e|PID footnote:[Example for BIPM PID: https://si-digital-framework.org/SI/units/ampere]
