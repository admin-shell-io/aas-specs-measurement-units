...
Constraints are prefixed with *AASc-3b-* followed by a three-digit number.
The "c" in "AASc-" was motivated by "Concept Description".
The numbering of constraints is unique within namespace AASc-3b; a number of a constraint that was removed will not be used again.
