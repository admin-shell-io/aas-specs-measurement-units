...
== Motivation
The publicly avbailable dictionaries for units of measurements vary greatly in their modelling approach and scope. 
...
* The source that was actually used and veryfied for the units should be used as a modelling basis. 
...
.Mapping recommendation and examples for ECLASS
[width="100%",cols="15%,5%,20%,20%,20%,20%"]
|===
|attribute (of data specification)              | card | mapping recommendation | Example 1 | Example 2 | Example 3
 
 |conceptDescription/id | 1    | _IRDI_ or _IRI_ of ECLASS unit |0173-1#05-AAA480#005|\https://api.eclass-cdp.com/0173-1-05-AAA480-003|0173-1#05-AAA793#002

 |preferredName         | 1    | _Preferred name_ of ECLASS unit|millimetre|millimetre|Kilogramm^-1
 |symbol                | 0..1 | _Short name_ of ECLASS unit|mm|mm|1/kg
 |specificUnitID        | 0..1 | _IRDI_, optionally if _IRI_ is provided as conceptDescription/id; otherwise omit||0173-1#05-AAA480#003|
 ...
 |preferredNameQuantity | 0..1 | _Quantity_ of ECLASS unit|distance|distance|reciprocal mass
 |quantityID            | 0..1 | _QuantityID_ of ECLASS unit| 0173-1#Z4-BAJ199#002|\https://api.eclass-cdp.com/0173-1-Z4-BAJ199-002|0173-1#Z4-AAB646#002
...
|attribute (of data specification)              | card | mapping recommendation | Example 1 | Example 2 | Example 3
 ...
 |conceptDescription/id | 1    | _IRDI_ of IEC CDD unit |0112/2///62720#UAA862#001|0112/2///62720#UAB246#001|0112/2///62720#UAA017#002

 |preferredName         | 1    | _Preferred name_ of IEC CDD unit|millimetre|tex|ohm
 |symbol                | 0..1 | _Short name_ of IEC CDD unit|mm|tex|Ω
 |specificUnitID        | 0..1 | -----|||
...
|attribute (of data specification)              | card | mapping recommendation | Example 1 | Example 2 | Example 3
 ...
 |symbol                | 0..1 | _Representation symbol_ of UNECE unit|mm|kcd|
...
|attribute (of data specification)              | card | mapping recommendation | Example 1 | Example 2 | Example 3
 ...
 |symbol                | 0..1 | _Symbol_ of BIPM unit|A|Da|mm
 |specificUnitID        | 0..1 | -----|||
...
|attribute (of data specification) | card | mapping recommendation | Example 1 | Example 2 | Example 3
 ...
 |symbol                | 0..1 | _displayName | mm|W·h|mm
...
|attribute (of data specification) | card | mapping recommendation | Example 1 | Example 2
 ...
 |classificationSystemVersion | 0..1 | ????? |2.2|2.2|
...
|attribute (of data specification)              | card | mapping recommendation | Example 1 | Example 2 | Example 3
 ...
 |preferredName         | 1    | _Preferred name_ of IEC CDD unit|millimetre|tex|ohm
 |symbol                | 0..1 | _Short name_ of IEC CDD unit|mm|m⁻¹ kg|Ω
 |specificUnitID        | 0..1 | -----|||
 |definition            | 0..1 | _Definition_ of IEC CDD unit||unit for the indication of the linear mass of textile fibers and yarns|SI derived unit with special name, for which the following relation applies: 1 Ω = 1 C·A⁻¹ = 1 S⁻¹ = 1 m²·kg¹·s⁻³·A⁻²
